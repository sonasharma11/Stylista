...
<head>
    ...
    <title>STYLISTA - Men's Collection</title>
    ...
    <style>
        ...
        .nav-icon-link {
            ...
            text-decoration: none;
            position: relative;
            /* Badge ke liye zaroori */
        }

        /* CSS FOR BADGE AND BUTTON START */
        .cart-badge {
            position: absolute;
            top: -5px;
            right: -10px;
        ...
        @media (max-width: 991px) {
            ...
            /* Force actions to be visible on touch devices */
            .product-actions {
                transform: translateY(0) !important;
            }
        }

        /* --- PHONE SPECIFIC (< 576px) --- */
...
<body>
    ...
    <section class="container-fluid px-3 px-md-5">
        <div class="mt-5 mb-5 d-flex justify-content-between align-items-center">
            <h3 class="section-header">Men Collection</h3>
        </div>
