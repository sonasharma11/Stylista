        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9">
                    <h4 class="text-light py-4 m-0">CONTACT</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-9">
                ...
                <img class="img-fluid hero-img" src="https://framerusercontent.com/images/bgGFaSXDTzVzKZiuPbgPow0oE.jpeg?scale-down-to=2048" alt="">

                <div class="mt-5">
                    <h1 class="fw-bold">Stylista World Headquarter</h1>
                    <p class="mt-3 fs-5">One Bowerman Drive Beaverton, OR 98760</p>
                    <p class="mt-3 fs-5">Agrico Park, Jamshedpue, INDIA</p>
                    <hr>
                </div>
                <div>
                    <h4 class="fw-bold">Have Questions, Concerns, or Feedback?</h4>
                    <p class="fs-6 mt-3">We’re here for you and eager to hear your thoughts!</p>
                    <p class="fs-6">If you have any additional inquiries, concerns, or suggestions, we’d be delighted to assist you. Your input is invaluable to us, and we’re always ready to listen.</p>
                    <p>Feel free to reach out by submitting your query through any of the contact options listed below. We’re looking forward to helping you!</p>
                </div>
                <hr>
                <div class="mt-5 mb-5">
                    <div class="row g-3">
                ...
                <h5 class="mt-5 mb-5">Your next shopping adventure is just a click away!</h5>
            </div>
        </div>
    </section>
