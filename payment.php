...
<head>
    ...
    <title>Payment Options - STYLISTA</title>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9">
                    <h4 class="text-light py-4 m-0">Payment Options</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-9">
                ...
                <img class="img-fluid hero-img" src="https://framerusercontent.com/images/CYXfNnBgPFoSk600wrXIguJRC1A.jpeg?scale-down-to=2048" alt="">

                <div class="mt-5">
                    <p class="fs-5">We aim to make your shopping experience convenient and flexible by offering a wide range of payment methods to suit your preferences. Below are the payment options available on our platform:</p>

                    <div class="mt-5">
                        <h5>Credit/Debit Cards</h5>
                        <p>We accept all major credit and debit cards, including Visa, MasterCard, American Express, and Discover. Your payment information is processed securely, ensuring a safe transaction every time.</p>
                    </div>

                    <div class="mt-4">
                        <h5>Digital Wallets</h5>
                        <p>Enjoy seamless payments through popular digital wallets like PayPal, Apple Pay, Google Pay, and Samsung Pay. These options offer an additional layer of convenience and security.</p>
                    </div>

                    <div class="mt-4">
                        <h5>Bank Transfers</h5>
                        <p>Direct bank transfer is available for those who prefer this method. Simply follow the instructions at checkout, and once the payment is confirmed, your order will be processed.</p>
                    </div>

                    <div class="mt-4">
                        <h5>Cash on Delivery (COD)</h5>
                        <p>For select regions, we offer the option to pay in cash upon receiving your order. This method is perfect for customers who prefer not to use online payment options.</p>
                    </div>

                    <div class="mt-4">
                        <h5>Buy Now, Pay Later</h5>
                        <p>Flexible payment plans are available through services like Klarna, Afterpay, or Affirm, allowing you to spread the cost of your purchase over time while enjoying your products immediately.</p>
                    </div>

                    <div class="mt-4">
                        <h5>Gift Cards and Store Credits</h5>
                        <p>Redeem Minna gift cards or store credits at checkout for an easy and hassle-free shopping experience.</p>
                    </div>

                    <p class="fs-5 mt-5 mb-5">All payments are processed through secure gateways that protect your data using advanced encryption technologies. Your trust and security are our top priorities. For any payment-related questions or assistance, our customer support team is always ready to help.</p>
                </div>
            </div>
        </div>
    </section>
